...
if __name__ == "__main__":
    ...
    asset_mapper_path = earthdaily.earthdatastore.cube_utils.asset_mapper.__asset_mapper_config_path
    asset_mapper_config = earthdaily.earthdatastore.cube_utils.asset_mapper._asset_mapper_config
