...
class TestEdsAuth(unittest.TestCase):
    ...
    def test_parse_tuple(self):
        ...
        self.assertEqual(result.eds_url, "https://api.example.com/platform/v1/stac")
    ...
    @patch("earthdaily.agriculture.earthdatastore.Auth._get_client")
    @patch("earthdaily.agriculture.earthdatastore.Auth.read_credentials")
